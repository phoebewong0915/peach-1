var ChartsAmcharts=function() {
    var e=function() {
        var e=AmCharts.makeChart("chart_1", {
            ...
            , {
                year: 2015rr, income: 34.1, expenses: 29.9, dashLengthColumn: 5, alpha: .2, additional: "(projection)"
            }
            ], valueAxes:[ {
                axisAlpha: 0, position: "left"
            }
            ], startDuration:1, graphs:[ {
                alphaField: "alpha", balloonText: "<span style='font-size:13px;'>[[title]] in [[category]]:<b>[[value]]</b> [[additional]]</span>", dashLengthField: "dashLengthColumn", fillAlphas: 1, title: "Income", type: "column", valueField: "income"
            }
            , {
                balloonText: "<span style='font-size:13px;'>[[title]] in [[category]]:<b>[[value]]</b> [[additional]]</span>", bullet: "round", dashLengthField: "dashLengthLine", lineThickness: 3, bulletSize: 7, bulletBorderAlpha: 1, bulletColor: "#FFFFFF", useLineColorForBulletBorder: !0, bulletBorderThickness: 3, fillAlphas: 0, lineAlpha: 1, title: "Expenses", valueField: "expenses"
            }
    ...
    t=function() {
        var e=AmCharts.makeChart("chart_2", {
            ...
            dataProvider:[ {
                date: "2012-05-12", Re_visit: 40.71, NewJoin: 12
            }
            , {
                date: "2012-05-13", Re_visit: 38.89, NewJoin: 10
            }
            , {
                date: "2012-05-14", Re_visit: 34.22, NewJoin: 4
            }
            , {
                date: "2012-05-15", Re_visit: 30.35, NewJoin: 7
            }
            , {
                date: "2012-05-16", Re_visit: 25.83, NewJoin: 8
            }
            , {
                date: "2012-05-17", Re_visit: 30.46, NewJoin: 3
            }
            , {
                date: "2012-05-18", Re_visit: 35, NewJoin: 7
            }
            
            ],
             valueAxes:[  {axisAlpha: 0, gridAlpha: 0, inside:!0, position: "right"}],
            ...
            graphs:[  {
                ...
                //fillAlphas: 0,
                valueField: "Re_visit",
                valueAxis: "Re_visitAxis"
            }
            , {
                bullet: "square",
                //bulletBorderAlpha: 1,
                //ulletBorderThickness: 1,
                //dashLengthField: "dashLength",
                //legendValueText: "[[value]]", 
                title: "NewJoin", 
                //fillAlphas: 0, 
                valueField: "NewJoin", 
                valueAxis: "NewJoinAxis"
            }
            ],
             chartCursor: {
                cursorAlpha: .1,
            ...
            /**
             exportConfig: {
                menuBottom:"20px", menuRight:"22px", menuItems:[ {
    ...
    ,
    a=function() {
        var e=AmCharts.makeChart("chart_3", {
            type:"serial",
            theme:"light",
            color:"#888888",
            dataProvider:[ {
                 date: "2012-01-01", duration: 408
            }
            , {
            ...
            valueAxes:[ {
                ...
                bullet: "square", bulletBorderAlpha: 1, bulletBorderThickness: 1, fillAlphas: .3, fillColorsField: "lineColor", legendValueText: "[[value]]", lineColorField: "lineColor", title: "duration", valueField: "duration"
            }
            ], chartScrollbar: {}
            , chartCursor: {
    ...
    l=function() {
        var e=AmCharts.makeChart("chart_4", {
            ...
            , {
                ...
                balloonText: "<span style='font-size:13px;'>[[title]] through [[category]]:<b>[[value]]</b></span>", title: "Access", type: "column", fillAlphas: .8, valueField: "access"
            }
            ], rotate:!0, categoryField:"AP", categoryAxis: {
                gridPosition: "start"
            }
        }
        );
    ...
    ,
    o=function() {
        var e=AmCharts.makeChart("chart_5", {
            theme:"light", type:"serial", startDuration:2, fontFamily:"Open Sans", color:"#888", dataProvider:[ {
            ...
            , {
                ...
                balloonText: "[[category]]: <b>[[value]]</b>", colorField: "color", fillAlphas: .85, lineAlpha: .1, type: "column", topRadius: 1, valueField: "visits"
            }
            ], depth3D:40, angle:30, chartCursor: {
                categoryBalloonEnabled: !1, cursorAlpha: 0, zoomable: !1
            }
            , categoryField:"country", categoryAxis: {
                gridPosition: "start", axisAlpha: 0, gridAlpha: 0
            }
            , exportConfig: {
                menuTop:"20px", menuRight:"20px", menuItems:[ {
        ...
        jQuery(".chart_5_chart_input").off().on("input change", function() {
            var t=jQuery(this).data("property"), a=e;
            e.startDuration=0, "topRadius"==t&&(a=e.graphs[0]), a[t]=this.value, e.validateNow()
        }
        ),
    ...
    i=function() {
        var e=AmCharts.makeChart("30day_gender", {
            ...
            //color:"#888",
            dataProvider:[ {
            Method: "Email", People: 18
            }
            , {
                Method: "Instagram", People: 6
            },
            {
                Method: "Twitter", People: 12
            },
            {
                Method: "No Login", People: 25
            }
            ],
            valueField:"People",
            titleField:"Method",
    ...
    ,
    n=function() {
        var e=AmCharts.makeChart("chart_8", {
            type:"radar", theme:"light", fontFamily:"Open Sans", color:"#888", dataProvider:[ {
                direction: "N", value: 8
            }
            , {
            ...
            , {
                ...
                gridType:"circles", minimum:0, autoGridCount:!1, axisAlpha:.2, fillAlpha:.05, fillColor:"#FFFFFF", gridAlpha:.08, guides:[ {
                    angle: 225, fillAlpha: .3, fillColor: "#0066CC", tickLength: 0, toAngle: 315, toValue: 14, value: 0, lineAlpha: 0
                }
                , {
                    angle: 45, fillAlpha: .3, fillColor: "#CC3333", tickLength: 0, toAngle: 135, toValue: 14, value: 0, lineAlpha: 0
                }
                ], position:"left"
            }
            ], startDuration:1, graphs:[ {
                balloonText: "[[category]]: [[value]] m/s", bullet: "round", fillAlphas: .3, valueField: "value"
            }
    ...
    u=function() {
        var e=AmCharts.makeChart("chart_9", {
            type:"radar", theme:"light", fontFamily:"Open Sans", color:"#888", dataProvider:[ {
                country: "Czech Republic", litres: 156.9
            }
            , {
                country: "Ireland", litres: 131.1
            }
            , {
                country: "Germany", litres: 115.8
            }
            , {
                country: "Australia", litres: 109.9
            }
            , {
                country: "Austria", litres: 108.3
            }
            , {
                country: "UK", litres: 99
            }
            ], valueAxes:[ {
                axisTitleOffset: 20, minimum: 0, axisAlpha: .15
            }
            ], startDuration:2, graphs:[ {
                balloonText: "[[value]] litres of beer per year", bullet: "round", valueField: "litres"
            }
            ], categoryField:"country", exportConfig: {
    ...
    r=function() {
        ...
        ,
        e.AN= {
            latitude: 12.25, longitude: -68.75
        }
        ,
        e.AO= {
        ...
        ,
        e.AR= {
            latitude: -34, longitude: -64
        }
        ,
        e.AS= {
            latitude: -14.3333, longitude: -170
        }
        ,
        e.AT= {
            latitude: 47.3333, longitude: 13.3333
        }
        ,
        e.AU= {
            latitude: -27, longitude: 133
        }
        ,
        e.AW= {
            latitude: 12.5, longitude: -69.9667
        }
        ,
        e.AZ= {
            latitude: 40.5, longitude: 47.5
        }
        ,
        e.BA= {
        ...
        ,
        e.BB= {
            latitude: 13.1667, longitude: -59.5333
        }
        ,
        e.BD= {
        ...
        ,
        e.BE= {
            latitude: 50.8333, longitude: 4
        }
        ,
        e.BF= {
            latitude: 13, longitude: -2
        }
        ,
        e.BG= {
        ...
        ,
        e.BH= {
            latitude: 26, longitude: 50.55
        }
        ,
        e.BI= {
            latitude: -3.5, longitude: 30
        }
        ,
        e.BJ= {
            latitude: 9.5, longitude: 2.25
        }
        ,
        e.BM= {
            latitude: 32.3333, longitude: -64.75
        }
        ,
        e.BN= {
            latitude: 4.5, longitude: 114.6667
        }
        ,
        e.BO= {
        ...
        ,
        e.BS= {
            latitude: 24.25, longitude: -76
        }
        ,
        e.BT= {
            latitude: 27.5, longitude: 90.5
        }
        ,
        e.BV= {
            latitude: -54.4333, longitude: 3.4
        }
        ,
        e.BW= {
            latitude: -22, longitude: 24
        }
        ,
        e.BY= {
            latitude: 53, longitude: 28
        }
        ,
        e.BZ= {
            latitude: 17.25, longitude: -88.75
        }
        ,
        e.CA= {
        ...
        ,
        e.CC= {
            latitude: -12.5, longitude: 96.8333
        }
        ,
        e.CD= {
        ...
        ,
        e.CF= {
            latitude: 7, longitude: 21
        }
        ,
        e.CG= {
            latitude: -1, longitude: 15
        }
        ,
        e.CH= {
        ...
        ,
        e.CI= {
            latitude: 8, longitude: -5
        }
        ,
        e.CK= {
            latitude: -21.2333, longitude: -159.7667
        }
        ,
        e.CL= {
            latitude: -30, longitude: -71
        }
        ,
        e.CM= {
            latitude: 6, longitude: 12
        }
        ,
        e.CN= {
            latitude: 35, longitude: 105
        ...
        ,
        e.CV= {
            latitude: 16, longitude: -24
        }
        ,
        e.CX= {
            latitude: -10.5, longitude: 105.6667
        }
        ,
        e.CY= {
        ...
        ,
        e.DM= {
            latitude: 15.4167, longitude: -61.3333
        }
        ,
        e.DO= {
            latitude: 19, longitude: -70.6667
        }
        ,
        e.DZ= {
            latitude: 28, longitude: 3
        }
        ,
        e.EC= {
            latitude: -2, longitude: -77.5
        }
        ,
        e.EE= {
            latitude: 59, longitude: 26
        }
        ,
        e.EG= {
            latitude: 27, longitude: 30
        }
        ,
        e.EH= {
            latitude: 24.5, longitude: -13
        }
        ,
        e.ER= {
            latitude: 15, longitude: 39
        }
        ,
        e.ES= {
        ...
        ,
        e.FI= {
            latitude: 62, longitude: 26
        }
        ,
        e.FJ= {
            latitude: -18, longitude: 175
        }
        ,
        e.FK= {
            latitude: -51.75, longitude: -59
        }
        ,
        e.FM= {
        ...
        ,
        e.GD= {
            latitude: 12.1167, longitude: -61.6667
        }
        ,
        e.GE= {
            latitude: 42, longitude: 43.5
        }
        ,
        e.GF= {
        ...
        ,
        e.GI= {
            latitude: 36.1833, longitude: -5.3667
        }
        ,
        e.GL= {
            latitude: 72, longitude: -40
        }
        ,
        e.GM= {
        ...
        ,
        e.GP= {
            latitude: 16.25, longitude: -61.5833
        }
        ,
        e.GQ= {
        ...
        ,
        e.GT= {
            latitude: 15.5, longitude: -90.25
        }
        ,
        e.GU= {
            latitude: 13.4667, longitude: 144.7833
        }
        ,
        e.GW= {
        ...
        ,
        e.HN= {
            latitude: 15, longitude: -86.5
        }
        ,
        e.HR= {
            latitude: 45.1667, longitude: 15.5
        }
        ,
        e.HT= {
            latitude: 19, longitude: -72.4167
        }
        ,
        e.HU= {
        ...
        ,
        e.IR= {
            latitude: 32, longitude: 53
        }
        ,
        e.IS= {
            latitude: 65, longitude: -18
        }
        ,
        e.IT= {
        ...
        ,
        e.JM= {
            latitude: 18.25, longitude: -77.5
        }
        ,
        e.JO= {
            latitude: 31, longitude: 36
        }
        ,
        e.JP= {
        ...
        ,
        e.KH= {
            latitude: 13, longitude: 105
        }
        ,
        e.KI= {
            latitude: 1.4167, longitude: 173
        }
        ,
        e.KM= {
            latitude: -12.1667, longitude: 44.25
        }
        ,
        e.KN= {
            latitude: 17.3333, longitude: -62.75
        }
        ,
        e.KP= {
        ...
        ,
        e.KY= {
            latitude: 19.5, longitude: -80.5
        }
        ,
        e.KZ= {
            latitude: 48, longitude: 68
        }
        ,
        e.LA= {
        ...
        ,
        e.LB= {
            latitude: 33.8333, longitude: 35.8333
        }
        ,
        e.LC= {
            latitude: 13.8833, longitude: -61.1333
        }
        ,
        e.LI= {
            latitude: 47.1667, longitude: 9.5333
        }
        ,
        e.LK= {
            latitude: 7, longitude: 81
        }
        ,
        e.LR= {
            latitude: 6.5, longitude: -9.5
        }
        ,
        e.LS= {
            latitude: -29.5, longitude: 28.5
        }
        ,
        e.LT= {
            latitude: 55, longitude: 24
        }
        ,
        e.LU= {
            latitude: 49.75, longitude: 6
        }
        ,
        e.LV= {
            latitude: 57, longitude: 25
        }
        ,
        e.LY= {
            latitude: 25, longitude: 17
        }
        ,
        e.MA= {
            latitude: 32, longitude: -5
        }
        ,
        e.MC= {
            latitude: 43.7333, longitude: 7.4
        }
        ,
        e.MD= {
            latitude: 47, longitude: 29
        }
        ,
        e.ME= {
            latitude: 42.5, longitude: 19.4
        }
        ,
        e.MG= {
            latitude: -20, longitude: 47
        }
        ,
        e.MH= {
            latitude: 9, longitude: 168
        }
        ,
        e.MK= {
        ...
        ,
        e.MN= {
            latitude: 46, longitude: 105
        }
        ,
        e.MO= {
            latitude: 22.1667, longitude: 113.55
        }
        ,
        e.MP= {
            latitude: 15.2, longitude: 145.75
        }
        ,
        e.MQ= {
            latitude: 14.6667, longitude: -61
        }
        ,
        e.MR= {
        ...
        ,
        e.MT= {
            latitude: 35.8333, longitude: 14.5833
        }
        ,
        e.MU= {
            latitude: -20.2833, longitude: 57.55
        }
        ,
        e.MV= {
            latitude: 3.25, longitude: 73
        }
        ,
        e.MW= {
        ...
        ,
        e.MX= {
            latitude: 23, longitude: -102
        }
        ,
        e.MY= {
            latitude: 2.5, longitude: 112.5
        }
        ,
        e.MZ= {
            latitude: -18.25, longitude: 35
        }
        ,
        e.NA= {
            latitude: -22, longitude: 17
        }
        ,
        e.NC= {
            latitude: -21.5, longitude: 165.5
        }
        ,
        e.NE= {
            latitude: 16, longitude: 8
        }
        ,
        e.NF= {
            latitude: -29.0333, longitude: 167.95
        }
        ,
        e.NG= {
        ...
        ,
        e.NR= {
            latitude: -.5333, longitude: 166.9167
        }
        ,
        e.NU= {
            latitude: -19.0333, longitude: -169.8667
        }
        ,
        e.NZ= {
        ...
        ,
        e.PF= {
            latitude: -15, longitude: -140
        }
        ,
        e.PG= {
            latitude: -6, longitude: 147
        }
        ,
        e.PH= {
            latitude: 13, longitude: 122
        }
        ,
        e.PK= {
        ...
        ,
        e.PT= {
            latitude: 39.5, longitude: -8
        }
        ,
        e.PW= {
            latitude: 7.5, longitude: 134.5
        }
        ,
        e.PY= {
            latitude: -23, longitude: -58
        }
        ,
        e.QA= {
            latitude: 25.5, longitude: 51.25
        }
        ,
        e.RE= {
        ...
        ,
        e.RO= {
            latitude: 46, longitude: 25
        }
        ,
        e.RS= {
            latitude: 44, longitude: 21
        }
        ,
        e.RU= {
        ...
        ,
        e.SB= {
            latitude: -8, longitude: 159
        }
        ,
        e.SC= {
            latitude: -4.5833, longitude: 55.6667
        }
        ,
        e.SD= {
        ...
        ,
        e.SJ= {
            latitude: 78, longitude: 20
        }
        ,
        e.SK= {
            latitude: 48.6667, longitude: 19.5
        }
        ,
        e.SL= {
            latitude: 8.5, longitude: -11.5
        }
        ,
        e.SM= {
        ...
        ,
        e.SO= {
            latitude: 10, longitude: 49
        }
        ,
        e.SR= {
            latitude: 4, longitude: -56
        }
        ,
        e.ST= {
            latitude: 1, longitude: 7
        }
        ,
        e.SV= {
            latitude: 13.8333, longitude: -88.9167
        }
        ,
        e.SY= {
            latitude: 35, longitude: 38
        }
        ,
        e.SZ= {
            latitude: -26.5, longitude: 31.5
        }
        ,
        e.TC= {
            latitude: 21.75, longitude: -71.5833
        }
        ,
        e.TD= {
        ...
        ,
        e.TF= {
            latitude: -43, longitude: 67
        }
        ,
        e.TG= {
            latitude: 8, longitude: 1.1667
        }
        ,
        e.TH= {
            latitude: 15, longitude: 100
        }
        ,
        e.TJ= {
            latitude: 39, longitude: 71
        }
        ,
        e.TK= {
            latitude: -9, longitude: -172
        }
        ,
        e.TM= {
        ...
        ,
        e.TT= {
            latitude: 11, longitude: -61
        }
        ,
        e.TV= {
            latitude: -8, longitude: 178
        }
        ,
        e.TW= {
        ...
        ,
        e.UY= {
            latitude: -33, longitude: -56
        }
        ,
        e.UZ= {
            latitude: 41, longitude: 64
        }
        ,
        e.VA= {
        ...
        ,
        e.VU= {
            latitude: -16, longitude: 167
        }
        ,
        e.WF= {
            latitude: -13.3, longitude: -176.2
        }
        ,
        e.WS= {
            latitude: -13.5833, longitude: -172.3333
        }
        ,
        e.YE= {
            latitude: 15, longitude: 48
        }
        ,
        e.YT= {
            latitude: -12.8333, longitude: 45.1667
        }
        ,
        e.ZA= {
            latitude: -29, longitude: 24
        }
        ,
        e.ZM= {
            latitude: -15, longitude: 30
        ...
        , {
            code: "TW", name: "Taiwan", value: 23072e3, color: "#eea638"
        }
        , {
        ...
        AmCharts.ready(function() {
            AmCharts.theme=AmCharts.themes.dark, t=new AmCharts.AmMap, t.pathToImages=App.getGlobalPluginsPath()+"amcharts/ammap/images/", t.fontFamily="Open Sans", t.fontSize="13", t.color="#888", t.addTitle("Population of the World in 2011", 14), t.addTitle("source: Gapminder", 11), t.areasSettings= {
                unlistedAreasColor: "#000000", unlistedAreasAlpha: .1
            }
            , t.imagesSettings.balloonText="<span style='font-size:14px;'><b>[[title]]</b>: [[value]]</span>";
            for(var n= {
                mapVar: AmCharts.maps.worldLow, images: []
            }
            , u=0;
            u<a.length;
            u++) {
                var r=a[u], c=r.value, s=(c-i)/(d-i)*(o-l)+l;
                l>s&&(s=l);
                var g=r.code;
                n.images.push( {
                    type: "circle", width: s, height: s, color: r.color, longitude: e[g].longitude, latitude: e[g].latitude, title: r.name, value: c
                }
                )
            }
    ...
    c=function() {
        ...
        a=AmCharts.makeChart("chart_11", {
            type:"map", theme:"light", pathToImages:App.getGlobalPluginsPath()+"amcharts/ammap/images/", fontFamily:"Open Sans", color:"#888", dataProvider: {
                map:"worldLow", linkToObject:"london", images:[ {
                    id:"london", color:"#000000", svgPath:e, title:"London", latitude:51.5002, longitude:-.1262, scale:1.5, zoomLevel:2.74, zoomLongitude:-20.1341, zoomLatitude:49.1712, lines:[ {
                    ...
                    , {
                        ...
                        label: "Flights from London", svgPath: t, left: 100, top: 45, labelShiftY: 5, color: "#CC0000", labelColor: "#CC0000", labelRollOverColor: "#CC0000", labelFontSize: 20
                    }
                    , {
                        label: "show flights from Vilnius", left: 106, top: 70, labelColor: "#000000", labelRollOverColor: "#CC0000", labelFontSize: 11, linkToObject: "vilnius"
                    }
                    ]
                }
                , {
                    id:"vilnius", color:"#000000", svgPath:e, title:"Vilnius", latitude:54.6896, longitude:25.2799, scale:1.5, zoomLevel:4.92, zoomLongitude:15.4492, zoomLatitude:50.2631, lines:[ {
                    ...
                    , {
                        ...
                        label: "Flights from Vilnius", svgPath: t, left: 100, top: 45, labelShiftY: 5, color: "#CC0000", labelColor: "#CC0000", labelRollOverColor: "#CC0000", labelFontSize: 20
                    }
                    , {
                        label: "show flights from London", left: 106, top: 70, labelColor: "#000000", labelRollOverColor: "#CC0000", labelFontSize: 11, linkToObject: "london"
                    }
                    ]
                }
                , {
            ...
            , imagesSettings: {
                color: "#CC0000", rollOverColor: "#CC0000", selectedColor: "#000000"
            }
            , linesSettings: {
                color: "#CC0000", alpha: .4
            }
            , backgroundZoomsToTop:!0, linesAboveImages:!0
        }
        );
    ...
    s=function() {
        function e() {
            ...
            a++) {
                ...
                var o=Math.round(Math.random()*(40+a))+100+a,
                i=Math.round(1e8*Math.random());
                t.push( {
                    date: l, value: o, volume: i
                }
                )
            }
        }
        var t=[];
        e();
        var a=AmCharts.makeChart("chart_12", {
            type:"stock", theme:"light", pathToImages:App.getGlobalPluginsPath()+"amcharts/amcharts/images/", fontFamily:"Open Sans", color:"#888", dataSets:[ {
                ...
                ], dataProvider:t, categoryField:"date", stockEvents:[ {
                    date: new Date(2010, 8, 19), type: "sign", backgroundColor: "#85CDE6", graph: "g1", text: "S", description: "This is description of an event"
                }
                , {
                    date: new Date(2010, 10, 19), type: "flag", backgroundColor: "#FFFFFF", backgroundAlpha: .5, graph: "g1", text: "F", description: "Some longerntext can alson be added"
                }
                , {
                    date: new Date(2010, 11, 10), showOnAxis: !0, backgroundColor: "#85CDE6", type: "pin", text: "X", graph: "g1", description: "This is description of an event"
                }
                , {
                    date: new Date(2010, 11, 26), showOnAxis: !0, backgroundColor: "#85CDE6", type: "pin", text: "Z", graph: "g1", description: "This is description of an event"
                }
                , {
                    date: new Date(2011, 0, 3), type: "sign", backgroundColor: "#85CDE6", graph: "g1", text: "U", description: "This is description of an event"
                }
                , {
                    date: new Date(2011, 1, 6), type: "sign", graph: "g1", text: "D", description: "This is description of an event"
                }
                , {
                    date: new Date(2011, 3, 5), type: "sign", graph: "g1", text: "L", description: "This is description of an event"
                }
                , {
                    date: new Date(2011, 3, 5), type: "sign", graph: "g1", text: "R", description: "This is description of an event"
                }
                , {
                    date: new Date(2011, 5, 15), type: "arrowUp", backgroundColor: "#00CC00", graph: "g1", description: "This is description of an event"
                }
                , {
                    date: new Date(2011, 6, 25), type: "arrowDown", backgroundColor: "#CC0000", graph: "g1", description: "This is description of an event"
                }
                , {
                    date: new Date(2011, 8, 1), type: "text", graph: "g1", text: "Longer text can\nalso be displayed", description: "This is description of an event"
                }
                ]
            }
            ], panels:[ {
                title:"Value", percentHeight:70, stockGraphs:[ {
            ...
            , chartCursorSettings: {
                valueBalloonsEnabled: !0, graphBulletSize: 1, valueLineBalloonEnabled: !0, valueLineEnabled: !0, valueLineAlpha: .5
            }
            , periodSelector: {
                periods:[ {
